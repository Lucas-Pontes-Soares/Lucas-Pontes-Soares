...
* **Graduação:** Análise e Desenvolvimento de Sistemas (AMS) na FATEC Ourinhos.
* **Técnico:** Desenvolvimento de Sistemas (AMS) na ETEC Ourinhos.
...
* **Atuação:** Ofereci soluções completas, desde projetos web até aplicativos móveis.
* **Responsabilidades:** Mantive e aprimorei sistemas existentes, corrigi bugs, e participei ativamente na criação de novas soluções.
* **Visão Abrangente:** Obtive experiência no ciclo de vida completo do desenvolvimento de software, da concepção à implementação final, abrangendo front-end, back-end, banco de dados e deploy.
