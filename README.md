...
> 🚀 Desenvolvedor Full-Stack focado em Engenharia de Back-end, Arquitetura de Software e IA.
...
Com quase 2 anos de experiência profissional em sistemas escaláveis, foco na construção de aplicações robustas e resilientes. Domino o ecossistema Node.js/TypeScript e venho me especializando na criação de APIs REST com Java e Spring Boot. 

<br>

Tenho forte inclinação para resolução de problemas complexos utilizando arquitetura limpa (SOLID, DDD), mensageria, automação e integração de soluções inteligentes de Inteligência Artificial (LLMs, RAG e Agentes de IA).

<br>

### 🎓 Formação Acadêmica

* **Graduação:** Análise e Desenvolvimento de Sistemas (AMS) — FATEC Ourinhos
* **Técnico:** Desenvolvimento de Sistemas (AMS) — ETEC Ourinhos

<br>

### 💻 Habilidades Técnicas & Ferramentas

#### Linguagens e Frameworks (Back-end & Front-end)
<p align="left">
  ...
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg" width="40px" height="40px" alt="Java" />&nbsp;
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/spring/spring-original.svg" width="40px" height="40px" alt="Spring Boot" />&nbsp;
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/php/php-original.svg" width="40px" height="40px" alt="PHP" />&nbsp;
...
#### Mensageria, Bancos de Dados & Cloud
<p align="left">
  ...
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg" width="40px" height="40px" alt="MySQL" />&nbsp;
  ...
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/amazonwebservices/amazonwebservices-original-wordmark.svg" width="40px" height="40px" alt="AWS" />&nbsp;
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/azure/azure-original.svg" width="40px" height="40px" alt="Azure" />&nbsp;
...
* **Inovação em IA:** Desenvolvi um gerador automatizado de relatórios PDF com suporte de Inteligência Artificial e construi uma aplicação de chatbot integrado com arquitetura RAG para responder a dúvidas e analisar relatórios de usuários.
...
Projeto para apresentar no evento da Geniuscon 2025 em Jacarezinho, conseguimos chegar nas finais.
  ...
  * Desenvolvi o front-end responsivo do nosso site para apresentar nosso projeto, e importei o modelo para testes.
  ...
  `TAGS:` IA, Python, CNN, React.js, Git, tailwind-css, shadcn-ui, Apresentação Técnica, Workshops, Palestras.
